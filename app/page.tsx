...
const content = {
  en: {
    ...
    heroText:
      "We guide international buyers through every stage of acquiring and managing property in Israel—from the right opportunity to years of hands-on ownership support.",
    ...
    whyText:
      "Israel combines long-term housing demand, limited land in key areas and a dynamic economy. For investors abroad, the opportunity is compelling—but local knowledge and disciplined execution are essential.",
    reasons: [
  ...
  he: {
    ...
    whyKicker: "למה ישראל",
    whyTitle: "שוק עמיד.\nנכס בעל משמעות.",
    whyText: "ישראל משלבת ביקוש ארוך טווח לדיור, היצע קרקע מוגבל באזורי ביקוש וכלכלה דינמית. עבור משקיעים מחו״ל זו יכולה להיות הזדמנות משמעותית — אך ידע מקומי וביצוע מדויק הם חיוניים.",
    reasons: [
